...
//    }
    ...
    public SuccessDataResult<GetCustomerByUsernameResponse> findByUsername(@RequestParam String username) {return this.customerService.findByUsername(username);}
}
